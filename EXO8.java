...
public class EXO8 {
    ...
    String ConfirmMotdepasse = scanner.nextLine();
    /*Fin du formulaire*/

    if (!motdepasse.equals(ConfirmMotdepasse)){/*Confirmation des mots de passe*/
    ...
    /*Fin connexion*/ 
    if (adresse.equals(adresseConnexion) && motdepasse.equals(motdepasseConnexion)) /*Confirmation de l'adresse et du mot de passe pour valider la connexion*/
